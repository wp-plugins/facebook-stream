...
function UpdateShortcode(){
    ...
    var complete_code = '[facebook-stream limit="'+stream_limit+'" cols="'+cols_limit+'" theme="'+stream_theme+'" padding="'+boxes_padding+'" margin_bottom="'+margin_bottom+'" fb_page_id="'+facebook_page_id+'" hide_no_media="'+only_media+'"]';
